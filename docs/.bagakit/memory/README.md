...
1) Search: `sh "$BAGAKIT_LIVING_DOCS_SKILL_DIR/scripts/living-docs-memory.sh" search '<query>' --root .`
2) Quote: `sh "$BAGAKIT_LIVING_DOCS_SKILL_DIR/scripts/living-docs-memory.sh" get <path> --root . --from <line> --lines <n>`
